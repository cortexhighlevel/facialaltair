...
const whatsappLink =
  "https://wa.me/5547933802402?text=Olá! Gostaria de agendar uma consulta.";
    ...
    <footer className="bg-primary text-primary-foreground">
      ...
      <div className="max-w-6xl mx-auto px-6 py-14">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          {/* Brand */}
          <motion.div {...fadeIn(0)} className="md:col-span-1 space-y-4">
            <img
              src={logoFooter}
          ...
          <motion.div {...fadeIn(0.2)} className="space-y-4">
            ...
            <ul className="space-y-2.5 text-sm text-primary-foreground/70">
              <li>
                ...
                >
                  WhatsApp: (47) 93380-2402
                </a>
              </li>
              <li>
                Rua 2300 nº 1100, Esquina com
                <br />a 4ª Avenida — Balneário Camboriú, SC
              </li>
            </ul>
          </motion.div>

          {/* Info + Social */}
          <motion.div {...fadeIn(0.3)} className="space-y-5">
            <div className="space-y-1.5">
              <p className="text-sm font-semibold">Med Menosso</p>
